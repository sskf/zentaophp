...
class baseRouter
{
   ...
   /**
    ...
    public function setModelFile($moduleName, $appName = '')
    {
        ...
        $extModelPrefix = ($siteExtended and !empty($this->siteCode)) ? $this->siteCode[0] . DS . $this->siteCode : ''; //ISS：https://github.com/easysoft/zentaophp/issues/8，原代码：$extModelPrefix  = ($siteExtended and !empty($this->siteCode)) ? $this->siteCode{0} . DS . $this->siteCode : '';
